...
$formAction = $isEdit
    ? 'index.php?controller=AdminBook&action=update'
    : 'index.php?controller=AdminBook&action=store';
?>

<!-- Breadcrumb -->
<div style="margin-bottom:18px; font-size:13px; color:#888;">
    <a href="index.php?controller=AdminBook&action=index" style="color:#e74c3c; text-decoration:none;">
...
<div class="admin-form-wrap">
    <h3>
        <i class="fa-solid fa-<?php echo $isEdit ? 'pen-to-square' : 'plus-circle'; ?>"
    ...
    <form method="POST" action="<?php echo $formAction; ?>" enctype="multipart/form-data">
        <?php if ($isEdit): ?>
        <input type="hidden" name="id" value="<?php echo (int)$sach['IDSach']; ?>">
        <?php endif; ?>
        ...
        <div class="form-row">
            ...
            <div style="display:flex; align-items:flex-start; gap:16px; flex-wrap:wrap;">
                <div>
                    <img id="preview-img"
                         src="public/images/sach/<?php echo htmlspecialchars($sach['HinhAnh']); ?>"
                ...
                <div style="flex:1;">
                    ...
                    <p style="font-size:12px; color:#aaa; margin-top:6px;">Chấp nhận: JPG, PNG, WEBP.</p>
                </div>
            </div>
            <?php else: ?>
                <img id="preview-img" src="" alt="" style="display:none; width:90px; height:120px; object-fit:cover; border-radius:6px; margin-bottom:8px;">
                <input type="file" id="hinhanh" name="hinhanh"
                       accept="image/jpeg,image/png,image/webp"
                       onchange="previewImage(this)">
                <p style="font-size:12px; color:#aaa; margin-top:6px;">Chấp nhận: JPG, PNG, WEBP.</p>
        ...
        <div style="display:flex; align-items:center; gap:12px; margin-top:8px;">
            ...
            <a href="index.php?controller=AdminBook&action=index" class="btn-cancel">
